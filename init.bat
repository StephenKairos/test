...
echo Do the following: Control Panel ^>^> User Account ^>^> Credential Manager ^>^> Windows Credential ^>^> Generic Credential
...
git push origin master
echo ----
echo [92mGit Identity Assignment Completed.[97m